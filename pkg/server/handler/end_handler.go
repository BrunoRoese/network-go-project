...
func HandleEndReq(request *protocol.Request) *protocol.Request {
	...
	res := (&protocol.End{}).BuildRequest(headers, "SUCCESS", *server.FileAddrMap[request.Information.Id.String()].LocalAddr().(*net.UDPAddr))
