...
func HandleFileReq(request *protocol.Request) *protocol.Request {
	...
	res := (&protocol.ACK{}).BuildRequest(headers, "OK", *server.FileAddrMap[request.Information.Id.String()].LocalAddr().(*net.UDPAddr))
